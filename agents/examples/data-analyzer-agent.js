...
export class DataAnalyzerAgent extends GaffAgentBase {
    ...
    async execute(input) {
        ...
        await this.think(`I need to analyze ${analysis_type} data. Let me break this down into steps.`, 1, 3, true);
...
`;
     ...
     */
    parseAnalysisResults(sandboxResult) {
...
//# sourceMappingURL=data-analyzer-agent.js.map